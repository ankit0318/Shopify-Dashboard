...
function handleClick(name) {
  ...
  return <StateContext.Provider value={{setMode,setColor,currentColor,themeSettings,setThemeSettings,activeMenu,currentMode, setCurrentMode,setActiveMenu,isClicked,handleClick,screenSizeRef}}>{children}</StateContext.Provider>;
};
