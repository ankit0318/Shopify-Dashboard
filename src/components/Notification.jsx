...
import notification from '../data/notification-on.svg';
export default function NotificationDropdown() {
  ...
  return (
    <div className="relative inline-block" ref={dropdownRef}>
      ...
      {/* Dropdown menu */}
      {isOpen && (
        <div className="absolute right-0 z-20 w-64 mt-5 overflow-hidden origin-top-right bg-white rounded-md shadow-lg sm:w-80 dark:bg-gray-800 transition transform duration-100 scale-100">
          <div className="py-2">
            {[
              {
                name: "Sara Salah",
